...
export default async function ContactPage() {
  ...
  return <main id="contenido" className="fast-page info-page contact-page">
    ...
    <aside className="contact-details">
      <a href={`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(restaurant.address)}`} target="_blank" rel="noreferrer"><MapPin aria-hidden="true" /><span><strong>Nuestra dirección</strong>{restaurant.address}</span></a>

...
const itemSeed = [
  { category: "hamburguesas", name: "Hamburguesa Clásica", slug: "hamburguesa-clasica", shortDescription: "Carne, queso, lechuga, tomate y salsa de la casa.", description: "Hamburguesa de carne a la parrilla con queso, lechuga fresca, tomate, pepinillos y salsa de la casa en pan con ajonjolí.", priceCents: 699, imageUrl: "/images/fast-food/burger-classic.webp", featured: true, chef: false, tags: [], ingredients: ["Carne de res", "Queso", "Lechuga", "Tomate", "Pepinillos"], allergens: ["Gluten", "Lácteos"], spicyLevel: null },
  { category: "hamburguesas", name: "Hamburguesa Doble", slug: "hamburguesa-doble", shortDescription: "Doble carne, cheddar, cebolla y pepinillos.", description: "Dos jugosas carnes a la parrilla, queso cheddar derretido, cebolla, lechuga, tomate maduro y pepinillos en pan brioche.", priceCents: 899, imageUrl: "/images/fast-food/burger-double.webp", featured: true, chef: true, tags: [], ingredients: ["Doble carne de res", "Cheddar", "Cebolla", "Lechuga", "Pepinillos"], allergens: ["Gluten", "Lácteos"], spicyLevel: null },
  { category: "hamburguesas", name: "Pollo Crunch", slug: "pollo-crunch", shortDescription: "Pollo crujiente, repollo y mayonesa picante.", description: "Pechuga de pollo empanizada, repollo fresco, pepinillos y mayonesa ligeramente picante en pan suave.", priceCents: 749, imageUrl: "/images/fast-food/hero.webp", featured: false, chef: false, tags: ["Picante"], ingredients: ["Pollo", "Repollo", "Pepinillos", "Mayonesa picante"], allergens: ["Gluten", "Huevo"], spicyLevel: 1 },
  { category: "pizzas", name: "Pizza Pepperoni", slug: "pizza-pepperoni", shortDescription: "Pepperoni, mozzarella y salsa de tomate.", description: "Nuestra masa artesanal con salsa de tomate, mozzarella y una capa generosa de pepperoni dorado.", priceCents: 1299, imageUrl: "/images/fast-food/pizza.webp", featured: true, chef: false, tags: [], ingredients: ["Masa", "Salsa de tomate", "Mozzarella", "Pepperoni"], allergens: ["Gluten", "Lácteos"], spicyLevel: null },
  { category: "pizzas", name: "Pizza Suprema", slug: "pizza-suprema", shortDescription: "Carnes, pimientos, cebolla y aceitunas.", description: "Mozzarella, pepperoni, jamón, pimientos, cebolla y aceitunas sobre salsa de tomate y masa recién horneada.", priceCents: 1599, imageUrl: "/images/fast-food/pizza-large.webp", featured: true, chef: true, tags: [], ingredients: ["Masa", "Mozzarella", "Pepperoni", "Jamón", "Vegetales"], allergens: ["Gluten", "Lácteos"], spicyLevel: null },
  { category: "pizzas", name: "Pizza Margarita", slug: "pizza-margarita", shortDescription: "Mozzarella, tomate y albahaca fresca.", description: "Una combinación sencilla de mozzarella, tomate y albahaca fresca sobre nuestra salsa y masa artesanal.", priceCents: 1099, imageUrl: "/images/fast-food/pizza-large.webp", featured: false, chef: false, tags: ["Vegetariano"], ingredients: ["Masa", "Mozzarella", "Tomate", "Albahaca"], allergens: ["Gluten", "Lácteos"], spicyLevel: null },
  { category: "combos", name: "Combo Clásico", slug: "combo-clasico", shortDescription: "Hamburguesa clásica, papas y refresco.", description: "Nuestra Hamburguesa Clásica acompañada de papas fritas crujientes y un refresco frío.", priceCents: 999, imageUrl: "/images/fast-food/hero.webp", featured: true, chef: false, tags: [], ingredients: ["Hamburguesa clásica", "Papas fritas", "Refresco"], allergens: ["Gluten", "Lácteos"], spicyLevel: null },
  { category: "combos", name: "Combo Doble", slug: "combo-doble", shortDescription: "Hamburguesa doble, papas y refresco.", description: "Hamburguesa Doble con una porción de papas fritas y el refresco de tu preferencia.", priceCents: 1199, imageUrl: "/images/fast-food/burger-double.webp", featured: false, chef: true, tags: [], ingredients: ["Hamburguesa doble", "Papas fritas", "Refresco"], allergens: ["Gluten", "Lácteos"], spicyLevel: null },
  { category: "combos", name: "Combo Pizza", slug: "combo-pizza", shortDescription: "Pizza personal, papas y refresco.", description: "Pizza personal de pepperoni, papas fritas y un refresco frío para una comida completa.", priceCents: 1049, imageUrl: "/images/fast-food/pizza.webp", featured: false, chef: false, tags: [], ingredients: ["Pizza pepperoni", "Papas fritas", "Refresco"], allergens: ["Gluten", "Lácteos"], spicyLevel: null },
  { category: "bebidas", name: "Refresco", slug: "refresco", shortDescription: "Elige tu sabor favorito.", description: "Refresco frío servido con hielo. Consulta los sabores disponibles al ordenar.", priceCents: 175, imageUrl: "/images/fast-food/hero.webp", featured: false, chef: false, tags: ["Sin gluten"], ingredients: ["Refresco", "Hielo"], allergens: [], spicyLevel: null },
  { category: "bebidas", name: "Limonada", slug: "limonada", shortDescription: "Limón recién exprimido y hielo.", description: "Limonada preparada al momento con limón fresco, agua, azúcar y mucho hielo.", priceCents: 225, imageUrl: "/images/fast-food/hero.webp", featured: false, chef: false, tags: ["Vegano", "Sin gluten"], ingredients: ["Limón", "Agua", "Azúcar", "Hielo"], allergens: [], spicyLevel: null },
  { category: "bebidas", name: "Agua", slug: "agua", shortDescription: "Agua purificada fría.", description: "Botella de agua purificada servida fría.", priceCents: 125, imageUrl: "/images/fast-food/hero.webp", featured: false, chef: false, tags: ["Vegano", "Sin gluten"], ingredients: ["Agua"], allergens: [], spicyLevel: null },
];
...
async function main() {
  const restaurantData = {
    ...
    address: "Centro Histórico, Quito, Ecuador",
    city: "Quito",
    countryCode: "EC",
    latitude: -0.220164,
    longitude: -78.512327,
    phone: "+593 2 255 5555",
    whatsapp: "593995555555",
    email: "hola@elbueno.ec",
